...
Namespace Facebook
    Public NotInheritable Partial Class GraphApi
        ...
        Implements GraphApi.IObject
            ...
            Public Property Languages() As GraphApi.Domain()
            ''' <summary>
            ''' Name: link
            ...
            Public Property AgeRange() As Object
            ''' <summary>
            ''' Name: third_party_id
            ...
            Public Property Installed() As System.Nullable(Of Boolean)
            ''' <summary>
            ''' Name: timezone
            ...
            Public Property Timezone() As System.Nullable(Of Double)
            ''' <summary>
            ''' Name: updatedTime
            ...
            Public Property Verified() As System.Nullable(Of Boolean)
            ''' <summary>
            ''' Name: bio
            ...
            Public Property Education() As GraphApi.Education()
            ''' <summary>
            ''' Name: email
            ...
            Public Property Hometown() As Object
            ''' <summary>
            ''' Name: interested_in
            ...
            Public Property PaymentPricepoints() As GraphApi.PaymentPricePoint()
            ''' <summary>
            ...
            Public Property FavoriteAthletes() As Object()
            ''' <summary>
            ''' Name: favorite_teams
            ...
            Public Property FavoriteTeams() As Object()
            ''' <summary>
            ''' Name: Picture
            ...
            Public Property SignificantOther() As Object
            ''' <summary>
            ...
            Public Property VideoUploadLimits() As VideoUploadLimit
            ''' <summary>
            ''' Name: website
            ...
            Public Property Work() As GraphApi.Job()
        End Class
    End Class
End Namespace
